...
const account1 = {
  ...
  movementsDates: [
    ...
    '2021-07-25T10:36:17.929Z',
    '2021-07-26T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
const calcDisplayBalance = function (acc) {
  ...
  const formatedBal = formatedCurrency(acc.balance, acc.locale, acc.currency);
